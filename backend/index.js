...
app.get('/popularinshoe', async (req,res) => {
    let products = await Product.find({category: "shoe"});
    let popular_in_shoe = products.slice(0,4);
    console.log("Popular in shoes fetched");
    res.send(popular_in_shoe);
})
...
// Creating endpoint for removing the products in cartdata
...
// Creating endpoint for cartitems
